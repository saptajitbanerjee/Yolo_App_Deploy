...
const iotData = new AWS.IotData({
    endpoint: "a5wukurtr1btx-ats.iot.ap-south-1.amazonaws.com",
    region: "ap-south-1", // Replace with your desired AWS region
    //apiVersion: '2015-05-28',
    credentials: {
        accessKeyId: "AKIAQHU4YOUVQINLI3UD",
        secretAccessKey: "gSqdCaDA8jHq078AQu8IXp6U/Eq+BiCszyWZN3EN",
    },
});
...
const publishMessage = (topic, message) => {
    const params = {
        ...
        qos: 2, // Change the Quality of Service (QoS) level if needed (0, 1, or 2)
    };
...
// Usage example:
const topic = "move_sub"; // Replace with your desired topic
...
const socket = new WebSocket(
    "wss://w8gjx4j7pg.execute-api.ap-south-1.amazonaws.com/production"
);
// Example:("wss://3143544j.execute-api.us-east-1.amazonaws.com/production");
//function connectWebSocket() {

//const socket = new WebSocket('wss://bc8p09eijf.execute-api.ap-south-1.amazonaws.com/production') 
// Example:("wss://3143544j.execute-api.us-east-1.amazonaws.com/production");
